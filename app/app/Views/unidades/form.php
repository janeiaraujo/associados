...
<?= $this->section('title') ?>
<?= $action === 'create' ? 'Nova Unidade' : 'Editar Unidade' ?>
<?= $this->endSection() ?>
...
<div class="row">
    <div class="col-lg-8 mx-auto">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="<?= base_url('unidades') ?>" class="btn btn-outline-secondary">
        ...
        <form method="post" action="<?= $action === 'create' ? base_url('unidades/store') : base_url('unidades/update/' . $unidade['id']) ?>">
            <?= csrf_field() ?>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control <?= session('errors.descricao') ? 'is-invalid' : '' ?>" 
                                      id="descricao" 
                                      name="descricao" 
                                      rows="3"><?= old('descricao', $unidade['descricao'] ?? '') ?></textarea>
                        ...
                        <div class="col-md-12">
                            <div class="form-check">
                                <input class="form-check-input" 
                                       ...
                                       name="ativo" 
                                       value="1" 
                                       <?= old('ativo', $unidade['ativo'] ?? 1) ? 'checked' : '' ?>>
            ...
            <div class="d-flex justify-content-end gap-2 mt-3">
                <a href="<?= base_url('unidades') ?>" class="btn btn-secondary">
                    Cancelar
                </a>
